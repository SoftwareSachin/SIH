...
const AssetDetectionPanel: React.FC = () => {
  ...
  const getAssetIcon = (assetType: string) => {
    if (assetType.includes('water') || assetType.includes('pond') || assetType.includes('lake') || assetType.includes('river')) {
      return <Waves className="h-5 w-5 text-blue-600 dark:text-blue-400" />;
    }
    if (assetType.includes('farm') || assetType.includes('agriculture') || assetType.includes('crop')) {
      return <Sprout className="h-5 w-5 text-green-600 dark:text-green-400" />;
    }
    if (assetType.includes('forest') || assetType.includes('tree') || assetType.includes('vegetation')) {
      return <Trees className="h-5 w-5 text-green-700 dark:text-green-400" />;
    }
    if (assetType.includes('homestead') || assetType.includes('built') || assetType.includes('settlement')) {
      return <Home className="h-5 w-5 text-orange-600 dark:text-orange-400" />;
    }
    ...
    return <MapIcon className="h-5 w-5 text-muted-foreground" />;
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-card dark:bg-card border border-border shadow-lg">
        <CardHeader className="border-b border-border bg-muted/50 dark:bg-muted/50">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-green-700 dark:bg-green-800 rounded">
          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-11 border-input bg-background text-foreground focus:border-primary focus:ring-primary/20"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="bg-muted/30 dark:bg-muted/30 p-4 rounded-lg border border-border">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <Label htmlFor="highRes" className="text-sm font-semibold text-foreground cursor-pointer">
